...
local btnTheme = Instance.new("ImageButton"); btnTheme.Size = UDim2.new(0, 20, 0, 20); btnTheme.Position = UDim2.new(1, -60, 0, 18); btnTheme.BackgroundTransparency = 1; -- EĞER TEKİL RESİM (ASSET ID) KULLANACAKSAN:
btnTheme.Image = "rbxassetid://7072718161"; btnTheme.ImageRectOffset = Vector2.new(0, 0); btnTheme.ImageRectSize = Vector2.new(0, 0)
