...
-- [[ HYPER|HUB - MULTI-LANGUAGE DROPDOWN MODULE ]]
local currentLang = env.HYPER_SAVE.Language or "EN"

local langData = {
    EN = {
        SysTab = "SYSTEM", MoreTab = "MORE", Remember = "Remember Changes",
        MaxFps = "Remove 500 FPS Limit", AutoExec = "Auto-Execute On Teleport",
        ExtNav = "External Navigation", Restart = "RESTART SCRIPT",
    ...
    TR = {
        SysTab = "SİSTEM", MoreTab = "DİĞER", Remember = "Değişiklikleri Hatırla",
        MaxFps = "500 FPS Sınırını Kaldır", AutoExec = "Işınlanmada Oto-Çalıştır",
        ExtNav = "Harici Gezinme", Restart = "SCRİPT'İ YENİDEN BAŞLAT",
    ...
    ES = {
        SysTab = "SISTEMA", MoreTab = "MÁS", Remember = "Recordar Cambios",
        MaxFps = "Límite de 500 FPS Desactivado", AutoExec = "Auto-Ejecutar al Teletransportar",
        ExtNav = "Navegación Externa", Restart = "REINICIAR SCRIPT",
        FpsMon = "Monitor de FPS en Vivo", Afk = "Optimización AFK",
        DynRes = "Escalador Dinámico (BETA)", DistCull = "Filtro de Calidad por Distancia",
        AnimLim = "Limitador de Animación", DeepRam = "Limpieza Profunda de RAM",
        Rejoin = "REUNIRSE AL SERVIDOR", InfoTitle = "Información:\n\nPara cerrar el script:\nPrimero minimice el menú, luego toque dos veces el ícono circular.",
    ...
    RU = {
        SysTab = "СИСТЕМА", MoreTab = "ЕЩЕ", Remember = "Запомнить Изменения",
        MaxFps = "Снять Лимит 500 FPS", AutoExec = "Авто-Запуск при Телепорте",
        ExtNav = "Внешняя Навигация", Restart = "ПЕРЕЗАПУСТИТЬ СКРИПТ",
...
langDropFrame.Size = UDim2.new(0.55, 0, 0, 0)
langDropFrame.Position = UDim2.new(0.45, 0, 1, 4)
langDropFrame.BackgroundColor3 = Color3.fromRGB(25, 25, 35)
langDropFrame.ClipsDescendants = true
langDropFrame.Visible = false
langDropFrame.ZIndex = 100
...
local function updateLanguageUI(code)
    ...
    btnSysTab.Text = t.SysTab
    btnFeatTab.Text = t.MoreTab
    btnRestartScript.Text = t.Restart
    infoBody.Text = t.InfoTitle
    btnCloseInfo.Text = t.CloseInfo
    btnConfirmYes.Text = t.Yes
    btnConfirmNope.Text = t.Nope
end
