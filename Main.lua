...
local btnTheme = Instance.new("ImageButton"); btnTheme.Size = UDim2.new(0, 20, 0, 20); btnTheme.BackgroundTransparency = 1; btnTheme.Image = "rbxasset://textures/ui/ColorPicker/Palette.png"; btnTheme.ImageColor3 = Color3.fromRGB(255, 255, 255); btnTheme.ImageTransparency = 0.3; btnTheme.ZIndex = 11; btnTheme.AnchorPoint = Vector2.new(0.5, 0.5); btnTheme.Position = UDim2.new(1, -50, 0, 28); btnTheme.Parent = contentContainer
